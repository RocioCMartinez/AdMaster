...
public class MainActivity extends AppCompatActivity {
    ...
    private AdRequest adViewRequest;
    private AdRequest adRewardRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adRewardButton = findViewById(R.id.MainActivityAdRewardButton);
    ...
    private void setupRewardedAd() {
        adRewardRequest = new AdRequest.Builder().build();

        RewardedAd.load(this, "ca-app-pub-3940256099942544/5224354917",
                adRewardRequest, new RewardedAdLoadCallback() {
                    @Override
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        // Handle the error.
                        Log.d(TAG, loadAdError.toString());
    ...
    private void setupAdRewardButton() {
        adRewardButton.setOnClickListener(v -> {
            if (rewardedAd != null) {
                ...
                rewardedAd.show(activityContext, new OnUserEarnedRewardListener() {
                    ...
                    public void onUserEarnedReward(@NonNull RewardItem rewardItem) {
                        ...
                        showRewardSnackbar(rewardAmount, rewardType);
                    }
                });
            } else {
    ...
    private void showRewardSnackbar(int rewardAmount, String rewardType) {
        ...
        snackbar.setAction("Dismiss", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle the Snackbar action if needed.
                snackbar.dismiss(); // Manually dismiss the Snackbar when the action button is clicked.
            }
        });
